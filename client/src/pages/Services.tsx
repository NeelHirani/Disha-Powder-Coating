...
import { detailedServices as services, technology, colorOptions, processSteps } from "@/data/services";
...
export default function Services() {
  ...
  return (
    <div className="overflow-x-hidden">
      <SEO
        title="Our Services - Professional Powder Coating | Disha Powder Coating"
        description="Comprehensive powder coating services including custom coating, color matching, special finishes, and protective coatings. RAL, Pantone, and custom colors available."
        keywords="powder coating services, custom coating, color matching, protective coating, industrial coating services, RAL colors, Pantone colors"
      />
      {/* HERO SECTION */}
